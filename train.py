...
class Train:
    def __init__(self,root):
        ...
        #Top Image
        img_top=Image.open(r"C:\Users\saksh\Downloads\face_detection\college_images\f9.webp")
        img_top=img_top.resize((1530,350))
        self.photoimg_top=ImageTk.PhotoImage(img_top)

        f_lbl=Label(self.root,image=self.photoimg_top)
        f_lbl.place(x=0,y=55,width=1530,height=323)
        ...
        #Bottom image
        img_bottom=Image.open(r"C:\Users\saksh\Downloads\face_detection\college_images\f4.jfif")
        img_bottom=img_bottom.resize((1530,350))
        self.photoimg_bottom=ImageTk.PhotoImage(img_bottom)

        f_lbl=Label(self.root,image=self.photoimg_bottom)
        f_lbl.place(x=0,y=430,width=1530,height=355)
